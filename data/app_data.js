window.WC_APP_DATA = {
      ...
      "products": [
        {
          ...
          "product_label": "Expected rainfall",
          "units": "mm per 12h",
          "nearest_peak": {
  ...
  "public_labeling_note": "Public website labels use plain-language rainfall-risk names. Internal variable names are preserved only in data files."
};
