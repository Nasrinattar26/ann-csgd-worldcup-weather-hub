window.WC_APP_DATA = {
  ...
  "init": "2026061200",
  "created_utc": "2026-06-12 18:25 UTC",
  "mode": "sample",
  "is_sample_data": true,
  "sample_note": "This is synthetic ANN12-like data used only to test the interactive dashboard before connecting the real ANN12-v4 NetCDF.",
  "products": [
    {
      "id": "expected_precip_mm",
    ...
    {
      "id": "prob_gt_2yrARI",
      "label": "Probability > 2-year ARI",
      "units": "%",
      "kind": "probability"
    },
    {
      "id": "prob_gt_5yrARI",
      "label": "Probability > 5-year ARI",
      "units": "%",
      "kind": "probability"
    }
  ],
  ...
  "city_summaries": [
    {
      ...
      "products": [
        ...
        {
          "product_id": "prob_gt_2yrARI",
          "product_label": "Probability > 2-year ARI",
          "units": "%",
          "nearest_peak": {
            "value": 12.445,
            "lead_hour": 72,
        ...
        {
          "product_id": "prob_gt_5yrARI",
          "product_label": "Probability > 5-year ARI",
          "units": "%",
          "nearest_peak": {
            "value": 6.306,
            "lead_hour": 72,
